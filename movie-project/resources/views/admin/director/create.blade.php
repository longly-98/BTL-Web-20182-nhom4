...
@section('title','Tạo đạo diễn mới')
@section('css')
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Tạo đạo diễn mới</h3>
        ...
        <div class="box-body">           
                ...
                <div class="box-body">
                    <div class="form-group {{ $errors->first('name') ? 'has-error' : ''}}">
                        ...
                        <input id="name" type="text" class="form-control" placeholder="Vui lòng nhập vào tên đạo diễn" name="name" value="{{ old('name') }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-body">
                            <div class="col-md-4 col-md-offset-4">
                                <img class="director-img img-responsive img-circle" src="" alt="" id="image_default">
                                <div align="center">

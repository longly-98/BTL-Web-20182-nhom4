...
@section('title','Sửa thông tin của diễn viên')
@section('css')
...
@section('content')
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Sửa thông tin của diễn viên</h3>
        ...
        <div class="box-body">            
                ...
                <div class="box-body">
                    <div class="form-group {{ $errors->first('name') ? 'has-error' : ''}}">
                        ...
                        <input id="name" type="text" class="form-control" placeholder="Vui lòng nhập vào tên diễn viên" name="name" value="{{ $person->name }}" required>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group {{ $errors->first('country_id') ? 'has-error' : ''}}">
                        ...
                        <select class="form-control" id="country_id" name ="country_id" required>
                            ...
                            <option value="{{$getcountry->name}}">{{$getcountry->name}}</option>
                            @endforeach
                        </select>                        
                    ...
                    <div class="form-group">
                        ...
                        <div class="box-body">
                            <div class="col-md-4 col-md-offset-4">
                                <div align="center">
                                    <img class="actor-img img-responsive" src="{{ asset('/storage/' . $person->image)}}" alt="1" height="50" width="50" id="image_default">
                                </div>
                                <div align="center">
